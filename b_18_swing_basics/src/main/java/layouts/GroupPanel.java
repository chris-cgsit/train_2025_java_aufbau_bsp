...
public class GroupPanel extends JPanel {
	...
	public GroupPanel(){
		...
		ParallelGroup zeileStrasse = layout.createParallelGroup(Alignment.BASELINE)
		 	.addComponent(lblStrasse)
		 	.addComponent(txtStrasse);
		
		// Plz/ort: Label und 2 Textboxen 
		ParallelGroup zeilePlzOrt = layout.createParallelGroup(Alignment.BASELINE)
		 	.addComponent(lblPlzOrt)
		 	.addComponent(txtPlz)
		 	.addComponent(txtOrt);
		
		// Ok/Abbrechen: die beiden Buttons 
		ParallelGroup zeileOkAbbrechen = layout.createParallelGroup(Alignment.BASELINE)
			.addComponent(btnOK)
			.addComponent(btnAbbrechen);
		...
		ParallelGroup spalte1 = layout.createParallelGroup(Alignment.LEADING)
			.addComponent(lblStrasse)
			.addComponent(lblPlzOrt);
		 
		// Spalte 2: der Rest 
		ParallelGroup spalte2 = layout.createParallelGroup(Alignment.LEADING)
			.addComponent(lblTitel)
			.addComponent(txtStrasse)
			.addGroup(grpPlzOrt)
			.addGroup(Alignment.CENTER, grpOkAbbrechen);
