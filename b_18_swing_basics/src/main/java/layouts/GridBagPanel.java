...
public class GridBagPanel extends JPanel {
	...
	public GridBagPanel() {
		...
		// "leere" zeile 4
		add(new JLabel(""), createCell(0, 3, 3, 1, 0, 1));
	}
	...
	private GridBagConstraints createCell(int gridx, int gridy, int gridwidth,
		...
		return new GridBagConstraints(gridx, gridy, gridwidth, gridheight, 
				weightX, // diesen Anteil an der horizontal verbleibenden Größe verwenden 
				0, // keinen Anteil an der vertikalen verbleibenden Größe
				WEST,
	...
	private GridBagConstraints createCell(int gridx, int gridy, int gridwidth,
		...
		return new GridBagConstraints(gridx, gridy, gridwidth, gridheight, weightX,
				weightY, // diesen Anteil an der vertikalen verbleibenden Größe
							// verwenden
				WEST,
				GridBagConstraints.BOTH, new Insets(2, 2, 2, 2), 0, 0);
	}
