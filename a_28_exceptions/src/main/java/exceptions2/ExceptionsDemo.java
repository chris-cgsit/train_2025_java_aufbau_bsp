...
public class ExceptionsDemo {
    ...
    private static void runCalculation() {
        ...
        try {
            ...
            // calculate darf nur in einem try mit passendem catch-Block aufgerufen werden
            // oder in einer Methode, die ebenfalls mit "throws CalculationException" deklariert ist
            result = calc.calculate(op, number1, number2);

            // Ergebnis anzeigen
            System.out.printf("%d%c%d=%d %n", number1, op, number2, result);
        }
        // hier ist die CalculationException eine Checked Exception, daher
        // ist der catch-Block erforderlich
